...
class SettlementCatalogTest(unittest.TestCase):
    def test_validates_exact_user_declared_projection_delta(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            write_json(path, {"schema_version": 1, "provenance": "user-supplied", "character_ids": [1, 2], "item_slots": 2, "summon_slots": 2, "max_stack": 99, "stages": [{"chapter": 2, "section": 1, "character_rewards": [2], "item_rewards": {"1": 3}, "summon_rewards": {"2": 1}, "clear_coins": 10}]})
    ...
    def test_rejects_noncanonical_or_duplicate_character_ids(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            path = Path(directory) / "settlement.json"
            write_json(path, {"schema_version": 1, "provenance": "user-supplied", "character_ids": [2, 2], "item_slots": 1, "summon_slots": 1, "max_stack": 1, "stages": [{"chapter": 2, "section": 1, "character_rewards": [], "item_rewards": {}, "summon_rewards": {}}]})
    ...
    def test_rejects_negative_clear_coins(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            path = Path(directory) / "settlement.json"
            write_json(path, {"schema_version": 1, "provenance": "user-supplied", "character_ids": [1], "item_slots": 1, "summon_slots": 1, "max_stack": 1, "stages": [{"chapter": 2, "section": 1, "character_rewards": [], "item_rewards": {}, "summon_rewards": {}, "clear_coins": -1}]})
