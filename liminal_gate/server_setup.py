    ...
    try:
        ...
        if outcome_catalog is None:
            print(
                ...
                f"  Generate {DEFAULT_OUTCOME_CATALOG} with liminal_gate.tester_setup "
                "and copy it into this data directory; see docs/dedicated-server.md"
            )
        else:
        ...
        if equipment_catalog is None:
            print(
                ...
                "  Generated by liminal_gate.tester_setup; see docs/dedicated-server.md"
            )
        else:
        ...
        if event_catalog is None:
            print(
                ...
                f"  Generate {DEFAULT_EVENT_CATALOG} and character-catalog.json with "
                "liminal_gate.tester_setup; see docs/dedicated-server.md"
            )
        else:
            print(
