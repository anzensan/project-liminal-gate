...
| Recovered Archive families | 2000, 2001, 2002, 2004, 2006 | Final-client flags, BattleData sections/economics, and four character associations | Generated by guided setup from matching user-local inputs. Permanent Chapter 2/4/10/13/20 gates, zero clear Coins, and first-section associated-character grants are local policy; original-client clears remain unverified. |
