...
| Dragon Road, Machine Road, Chapter 1100 routes | The operator's own BattleData carries no rewards for these stages. | Settle at zero; a clear claiming Coins, EXP, items, or Companions is refused. Documented for players in `docs/scope-and-status.md`. |
